...
public class CharacterMovementNoCamera : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        // set sprinting
        isSprinting = (UnityEngine.Input.GetKey(sprintJoystick) || UnityEngine.Input.GetKey(sprintKeyboard)) && speed > 0;
        ...
        var rotInput = new Vector2(UnityEngine.Input.GetAxis("Mouse X"), UnityEngine.Input.GetAxis("Mouse Y"));
